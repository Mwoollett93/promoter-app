...
import type { SeasonSnapshot } from "@/lib/season/season-insights";
import { SECTION_CARD_INNER } from "@/lib/ui/page-surfaces";

type SeasonSummaryStripProps = {
  snapshot: SeasonSnapshot;
};

export default function SeasonSummaryStrip({ snapshot }: SeasonSummaryStripProps) {
